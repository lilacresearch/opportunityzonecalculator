require 'date'
    ...
    class HeadOfHousehold
        ...
        def determineRate
            ...
            #Heads of Household with incomes over $200,000 per year are subject to an additional 3.8% Net Investment Income Tax.
            if (@income > 200000)
        ...
        def normalGain
            ...
            return (@salesPrice - @basis) * (@rate + netInvestmentTaxRate)  #the computed capital gain(using actual basis) times the applicable tax rate
